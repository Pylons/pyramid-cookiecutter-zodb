...
- Submit pull requests to the [`master` branch](https://github.com/Pylons/pyramid-cookiecutter-zodb/tree/master).  This branch is *not* the default and must be selected instead of [`latest`].  See the [README.rst, under Versions](https://github.com/Pylons/pyramid-cookiecutter-zodb#versions).
...
Follow the instructions in [README.rst](https://github.com/Pylons/pyramid-cookiecutter-zodb) to install the tools needed to run the project.
